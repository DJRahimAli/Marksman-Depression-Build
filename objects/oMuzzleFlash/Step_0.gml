...
{
	var muzzleflashangleoffset = point_direction(0, 0, oWeapon.currentxoffset, -oWeapon.currentyoffset);
	var muzzleflashdistanceoffset = point_distance(0, 0, oWeapon.currentxoffset, -oWeapon.currentyoffset);
}
if (oWeapon.aimside == 1)
{
	var muzzleflashangleoffset = point_direction(0, 0, oWeapon.currentxoffset, oWeapon.currentyoffset);
