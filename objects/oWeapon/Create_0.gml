...
#region Unarmed (0)
	...
	#region Hitspark
		#region Primary
			...
			ds_map_add(weapons[weapontype],"primaryhitsparkspritespeed",0);
		#endregion
		#region Secondary
			...
			ds_map_add(weapons[weapontype],"secondaryhitsparkspritespeed",0);
		#endregion
	#endregion
...
#region Pistol (1)
	...
	#region Weapon
		#region Position
			...
			ds_map_add(weapons[weapontype],"crouchyoffset",18);
