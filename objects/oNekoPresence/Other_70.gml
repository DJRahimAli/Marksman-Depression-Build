...
if (ev_type == "DiscordReady")
{
	...
	np_setpresence_more("Small image text", "Work in Progress: Made by Dj_Kirby (Disc Jockey Games)", false);
	
	//np_setpresence() should ALWAYS come the last!!
	np_setpresence(string(playerisdead), "Current Room: " + room_get_name(room), "marksman_icon", "");
